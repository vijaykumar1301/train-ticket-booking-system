        ...
        <nav class=" nim-menu navbar navbar-default navbar-fixed-top">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"> <?php for ($i = 0; $i < strlen($title); $i++) echo $title[$i]; ?></a>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <h1 class="main-heading-title">Bharat Yatra</h1>

                            <p class="main-heading-text">The Bharat Yatra Railways network is vast and covers a substantial distance.
                                 The total length of the railway network is over 68,000 route kilometers, making it one of the largest railway networks in the world
                                <br />The Bharat Yatra connects most states and union territories in the country.
                                 It plays a crucial role in providing connectivity to remote areas, urban centers, and industrial hubs. 
                                 The network reaches across the length and breadth of India, linking regions from Jammu and Kashmir in the north to Kanyakumari in the south, and from Gujarat in the west to Assam in the east.
                            </p>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-center black">
                        ...
                        <p class="a-slog">Developed By Vijay and Magesh</p>
